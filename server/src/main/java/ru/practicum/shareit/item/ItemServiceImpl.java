...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    public ItemWithCommentsDto getDtoById(Long itemId) {
    ...
    @Override
    public List<ItemWithCommentsDto> getByUserId(Long userId) {
    ...
    public CommentShowDto postComment(CommentCreateDto commentCreateDto) {
        ...
        Booking booking = bookingRepository.findByBookerIdAndItemId(commentCreateDto.getAuthorId(),
                commentCreateDto.getItemId()).orElseThrow(() -> new AlreadyExistException(
